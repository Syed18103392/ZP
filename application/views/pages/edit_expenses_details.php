                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     <div class="card">
                         ...
                         <div class="card-content">
                             <div class="row">
                                 <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('expenses_controller/update_expenses'); ?>" method="post">
                                     <h2 class="text-center"> ব্যয়ের তথ্য হালনাগাদ </h2>
                                     <input type="hidden" name="exid" value="<?php echo $sqlq->id; ?>">
                                     <fieldset>

                                         <div class="form-group hidden">
                                             <label class="col-md-2 control-label"> আইডি নাম্বার </label>
                                             <div class="col-md-1"><strong> : *</strong></div>
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <input type="number" name="expensesid" required value="<?php echo $sqlq->expenses_id; ?>">
                                                 </div>
                                             </div>
                                         </div>
                                                 ...
                                                 <div class="input-field">
                                                     ...
                                                     <select class="icons" name="mainhead" id="main_head">
                                                         ...
                                                         <?php
                                                            ...
                                                            foreach ($rec as $row) :
                                                                $s++;
                                                                if ($row->id == $sqlq->main_head) {
                                                            ?>
                                                                 <option value="<?php echo $sqlq->main_head; ?>" selected><?php echo $sqlq->headname; ?></option>
                                                             <?php
                                                                } else {
                                                                ?>
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field" id="sub_head">
                                                     ...
                                                     <select class="icons" name="subhead">
                                                         <option value="<?php echo  $single_post_data['sub_head_id'] ?>"><?php echo $sqlq->sub_head; ?></option>
                                                     </select>
                                                 </div>
                                             </div>
                                             <!--  <label class="col-md-1 control-label"> 
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     ...
                                                     <select class="icons" name="projecttype" id="projecttype" onchange="getInfo()">
                                                         ...
                                                         <?php if ($sqlq->porject_type == 'tender') { ?>
                                                             <option value="tender">দরপত্র</option>
                                                             <option value="pic"> পি আই সি </option>
                                                             <option value="dpm"> ডি পি এম </option>
                                                             <option value="quat"> কোটেশান </option>
                                                         ...
                                                         <?php if ($sqlq->porject_type == 'others') { ?>
                                                             <option value="others"> অন্যান্য </option>
                                                             <option value="pic"> পি আই সি </option>
                                                             <option value="dpm"> ডি পি এম </option>
                                                             <option value="tender">দরপত্র</option>
                                         ...
                                         <div class="form-group">
                                             <label class="col-md-2 control-label">প্রকল্পেরh নাম </label>
                                             <div class="col-md-1"><strong> : </strong></div>
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <input type="text" name="projectname" value="<?php echo $sqlq->project_title; ?>">
                                                 </div>
                                             </div>
                                         </div>
                                                     ...
                                                     <select class="icons" name="bank">
                                                         <?php
                                                            ...
                                                            foreach ($rec as $row) :
                                                                ...
                                                                if ($row->id == $sqlq->bank) {
                                                            ?>
                                                                 <option value="<?php echo $sqlq->bank; ?>" selected><?php echo $sqlq->bank_name; ?></option>
                                                             <?php
                                                                } else {
                                                                ?>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <input type="text" name="bank_branch" value="<?php echo $sqlq->branch_name; ?>">
                                                 </div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <input type="text" name="accountno" required value="<?php echo $sqlq->account_no; ?>">
                                                 </div>
                                             </div>
                                         </div>
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <select class="icons" name="paymentmode" id="paymentmode" onchange="getInfoA()">
                                                         <option><?php echo $sqlq->payment_mode; ?></option>
                                                         <option> নগদ </option>
                                                         <option> চেক </option>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <input type="text" class="tcal" name="date" required value="<?php echo $sqlq->pay_date; ?>">
                                                 </div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-10" style="margin-left:10px;">
                                                 <table id="itemTable" style="background:#FFF; color:#549AB2; text-align:center">
                                                     ...
                                                     <tr>
                                                         <td><input type="text" name="challan" value="<?php echo $sqlq->challan; ?>"></td>
                                                         <td><input type="text" name="voucher" value="<?php echo $sqlq->voucher; ?>"></td>
                                                         <td><input type="text" name="amount" value="<?php echo $sqlq->amount; ?>"></td>
                                                         <td><input type="text" name="payto" value="<?php echo $sqlq->pay_to; ?>"></td>
                                                     </tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-7">
                                                 <div class="input-field">
                                                     <textarea style="height:250px" name="details"><?php echo $sqlq->details; ?></textarea>
                                                 </div>
                                             </div>
                                         </div>
                                         <div class="form-group">
 ...
 <script type="text/javascript">
     ...
     //call function on load to add the first item
 </script>
