                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <ul class="link hidden-xs">
                                <li><a href="<?php echo base_url()?>Page/add_expenses">  অনিষ্পন্ন ব্যয় সংযুক্তি </a></li>
                            </ul>
                        </div>
                    </section>
                                ...
                                <div class="card">
                                    <div class="card-content">
                                        <div class="table-responsive">
                                          <div id="printableArea">	
                                            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                                ...
                                                <td>
                                                  <a title="Approved" 
                                                    href="<?php echo base_url('expenses_details/'.$row->id); ?>">
                                        ...
                                        <?php if($userid == 'super' || $userid == 'sub' || $userid == 'accounts' ){ ?>	
                                                 <a title="Approved" 
                                                    href="<?php echo base_url('Status/expenditure/'.$row->id); ?>">
                                                    <button class="btn btn-sm" data-toggle="tooltip" data-placement="left" title="Approved">অনুমোদন</button>
                                                    </a>
                                                  
                                                  <a title="Edit"  href="<?php echo base_url('Edit_view/expenditue_edit/'.$row->id); ?>">
                                                          <button class="btn btn-sm" data-toggle="tooltip" data-placement="left" title="Edit">
                                                           সংস্কার</button>
                                                   </a>
												   
												   <a title="Delete" href="<?php echo base_url('Delete/expenditure/'.$row->id); ?>" 
