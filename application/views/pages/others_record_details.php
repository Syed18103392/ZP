<?php
$sql = $others_record_complete_info;
?>
                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    <div id="div_print">
                                        <table width="801" class="table table-striped" height="354" border="1" align="center" style="background:#FFF; border:1px solid #23374e; padding-left:10px; color:#000;">
                                            ...
                                            <tr style="background:#999; color:#FFF; height:25px;">
                                                ...
                                                <td colspan="4">
                                                    <span style="font-family:Tahoma, Geneva, sans-serif; text-align:center; font-size:20px; font-weight:bold;">
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; অন্যান্য রেকর্ড </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="147"> আইডি নাম্বার </td>
                                                <td width="10"> : </td>
                                                <td width="233"><?php echo $sql->racordid; ?></td>
                                                <td width="138"> অর্থবছর </td>
                                                <td width="7"> : </td>
                                                <td width="226"><?php echo $sql->session;  ?></td>
                                            </tr>
                                            <tr>
                                                <td> প্রধান খাত </td>
                                                <td> : </td>
                                            ...
                                            <tr>
                                                <td> কাজ সমাপ্তির বছর </td>
                                                <td> : </td>
                                                <td><?php echo $sql->end_year; ?></td>

                                                <td> বাস্তবায়নকৃত প্রতিষ্ঠান </td>
                                                <td> : </td>
                                                <td><?php echo $sql->work_company; ?></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td> আলোকচিত্র </td>
                                                <td> : </td>
                                                <td><?php echo $sql->photo_graph; ?></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <a href="#" onclick="window.open('<?php echo base_url(); ?>uploads/files/other_recoad/<?php echo $sql->racordid; ?>/<?php echo $v; ?>')"> ফাইল দেখুন </a>

                                                    </td>
                                                    <td valign="top">
                                                        <a href="<?php echo base_url(); ?>uploads/files/other_recoad/<?php echo $sql->racordid; ?>/<?php echo $v; ?>" download>ফাইল ডাউনলোড </a>
