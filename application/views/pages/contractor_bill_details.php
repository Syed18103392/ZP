<?php
$sql = $contractor_bill_complete_info;
?>
                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    <div id="div_print">
                                        <table class="table table-striped" width="780" height="291" border="1" align="center" style="background:#FFF; border:1px solid #23374e; padding-left:10px; color:#000;">
                                            ...
                                            <tr>
                                                <td width="123"> ঠিকাদার প্রতিষ্ঠান </td>
                                                <td width="7"> : </td>
                                                <td width="210"><?php echo  $cid =  $sql->contractor_id; ?> </td>
                                                <td height="33"> অর্থ বছর </td>
                                                <td> : </td>
                                                <td><?php echo $sql->session;  ?></td>
                                            </tr>

                                            <tr>
                                                <td height="28"> প্রকল্পের নাম </td>
                                                <td> : </td>
                                                <td class="center"><?php echo  $pid =  $sql->project_name; ?></td>
                                                <td> প্রক্কলিত মূল্য </td>
                                                <td> : </td>
                                                <td><?php echo $sql->contract_price; ?></td>
                                            </tr>

                                            <tr>
                                                <td height="28"> বিলের ধরন </td>
                                                <td> : </td>
                                                <td><?php echo $sql->advance_price; ?></td>
                                                <td> এন্ট্রি তারিখ </td>
                                                <td>: </td>
                                            ...
                                            <tr>
                                                <td height="28"> দরপত্র জামানত (%)</td>
                                                <td> : </td>
                                                <td><?php echo $sql->perfor_comi; ?></td>
                                                <td> দরপত্র জামানত </td>
                                                <td> : </td>
                                                <td><?php echo $sql->perfor_amout; ?></td>
                                            </tr>


                                            <tr>
                                                <td height="28"> ভ্যাট (%)</td>
                                                <td> : </td>
                                                <td><?php echo $sql->vat_comi; ?></td>
                                                <td> ভ্যাট (পরিমাণ)</td>
                                                <td> : </td>
                                                <td><?php echo $sql->vat_amount; ?></td>
                                            </tr>


                                            <tr>
                                                <td height="28"> আয় কর (%)</td>
                                                <td> : </td>
                                                <td><?php echo $sql->income_comi; ?></td>
                                                <td> আয় কর (পরিমাণ )</td>
                                                <td> : </td>
                                                <td><?php echo $sql->income_amount; ?></td>
                                            </tr>


                                            <tr>
                                                <td height="28"> সর্বমোট টাকা </td>
                                                <td> : </td>
                                                <td><?php echo $sql->total_amount; ?></td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <a href="#" onclick="window.open('<?php echo base_url(); ?>uploads/files/Contractor_bill/<?php echo $sql->bill_id; ?>/<?php echo $filein; ?>')">ফাইল দেখুন </a>

                                                    </td>
                                                    <td valign="top">
                                                        <a href="<?php echo base_url(); ?>uploads/files/Contractor_bill/<?php echo $sql->bill_id; ?>/<?php echo $filein; ?>" download> ফাইল ডাউনলোড </a>
