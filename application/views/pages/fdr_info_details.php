        ...
        <section class="content-header z-depth-1">
            ...
            <div class="header-title">
                ...
                <ul class="link hidden-xs">
                    ...
                    <li><a href="<?php echo base_url() ?>add-new-fdr-info"> এফ ডি আর সংযুক্তি </a></li>
                </ul>
            </div>
        </section>
        <!-- page section -->
                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    <div id="div_print">
                                        <table class="table table-striped" width="780" height="179" border="1" align="center" style="background:#FFF; border:1px solid #23374e; padding-left:10px; color:#000;">
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="121" height="34"> ব্যাংকের নাম </td>
                                                <td width="7"> : </td>
                                                <td width="209"><?php echo $sqlB->bank_name; ?></td>
                                                <td width="121">&nbsp;</td>
                                                <td width="7"> </td>
                                                <td width="209"><?php // echo $sqlF->add_date; 
                                                                ?></td>

                                            </tr>
                                            <tr>
                                                <td height="23"> শাখার নাম </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->branch; ?></td>
                                                <td> এফ ডি আর নং </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->fdr_number; ?></td>
                                            </tr>
                                            <tr>
                                                <td height="23"> পারম্ভিক এফ ডি আর </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->start_fdr; ?></td>
                                                <td> খোলার তারিখ </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->start_date; ?></td>
                                            </tr>

                                            <tr>
                                                <td height="25"> বর্তমান এফ ডি আর</td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->present_fdr; ?></td>

                                                <td> খোলার তারিখ </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->present_date; ?></td>
                                            </tr>

                                            <tr>
                                                <td height="25">মেয়াদকাল </td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->duration; ?></td>

                                                <td> মুনাফার হার</td>
                                                <td> : </td>
                                                <td><?php echo $sqlF->interst; ?></td>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <a href="#" onclick="window.open('<?php echo base_url(); ?>uploads/files/FDR/<?php echo $sqlF->fdr_id; ?>/<?php echo $v; ?>')">ফাইল দেখুন </a>

                                                    </td>
                                                    <td valign="top">
                                                        <a href="<?php echo base_url(); ?>uploads/files/FDR/<?php echo $sqlF->fdr_id; ?>/<?php echo $v; ?>" download> ফাইল ডাউনলোড </a>
