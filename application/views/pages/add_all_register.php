        ...
        <section class="content-header z-depth-1">
            ...
            <div class="header-title">
                ...
                <ul class="link hidden-xs">
                    ...
                    <li><a href="<?php echo base_url() ?>Register/new_register"> নিবন্ধন ফাইল সংযুক্ত</a></li>
                </ul>
            </div>
        </section>
        <!-- page section -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="row">
                                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('all_register_controller/add_all_register'); ?>" method="post">
                                    <h2 class="text-center"> নিবন্ধন ফাইল সংযুক্তি ফর্ম </h2>
                                    <fieldset>
                                        <input type="hidden" name="register_id" value="<?php echo time(); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    <input type="text" name="opening_date" class="tcal">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    <input type="text" name="ending_date" class="tcal">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-field">
                                                    <input type="text" name="total_page">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class=nput-field">
                                                    <input type="text" class="tcal" name="ceo_date">
                                                </div>
                                            </div>
                                        </div>
