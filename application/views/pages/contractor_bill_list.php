    ...
    <div class="page-content">
        ...
        <section class="content-header z-depth-1">
            ...
            <div class="header-title">
                <h1> পি.আই.সি / ঠিকাদার বিল সমূহ </h1>
                <?php
                            ...
                            <div class="table-responsive">
                                <div id="printableArea">
                                    <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            $rec = $list_of_contractor_bill_record;
                                            $i = 0;
                                            foreach ($rec as $row) :
                                                $i++;
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="center"><?php echo $pid =  $row->project_name; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($userid == 'super' || $userid == 'sub' || $userid == 'accounts') { ?>
                                                            <a title="Edit" href="<?php echo base_url('edit-contractor-bill/' . $row->id); ?>"><button class="btn btn-sm" data-toggle="tooltip" data-placement="left" title="Edit"> সংস্কার </button></a>

                                                            <a title="Delete" href="<?php echo base_url('delete-contractor-bill/' . $row->id); ?>" onClick="return confirm('Are you sure Delete This Option?');">
                                                        ...
                                                        <!-- <a title="Edit"  href="<?php echo base_url('Edit_view/contractor_bill_edit/' . $row->id); ?>">
