<?php
$sql = $all_register_complete_info;
        ...
        <section class="content-header z-depth-1">
            ...
            <div class="header-title">
                ...
                <ul class="link hidden-xs">
                    <!-- 
                                <li><a href="<?php echo base_url() ?>/Register/all_register">সকল  নিবন্ধন ফাইল সমূহ </a></li>
                        ...
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                                    <div id="div_print">
                                        <table width="770" height="291" border="1" align="center" class="table table-striped" style="background:#FFF; border:1px solid #23374e; padding-left:10px; color:#000;">
                                            ...
                                            <tr>
                                                <td width="162" height="29">আইডি</td>
                                                <td width="9"> : </td>
                                                <td width="189"><?php echo $sql->register_id; ?></td>

                                                <td width="142"> বিষয়</td>
                                                <td width="7"> : </td>
                                                <td width="221"><?php echo $sql->subject; ?></td>
                                            </tr>
                                            <tr>
                                                <td height="31"> খোলার তারিখ</td>
                                                <td>:</td>
                                                <td><?php echo $sql->opening_date; ?></td>
                                                <td> বন্ধের তারিখ </td>
                                                <td> : </td>
                                                <td><?php echo $sql->close_date;  ?></td>
                                            </tr>

                                            <tr>
                                                <td height="31"> শাখা </td>
                                                <td>: </td>
                                                <td><?php echo $sql->sector;  ?></td>
                                                <td> মোট পৃষ্ঠা সংখ্যা </td>
                                                <td> : </td>
                                                <td><?php echo $sql->total_page; ?></td>
                                            </tr>



                                            <tr>
                                                <td> সিইও কর্তৃক সত্যায়িত তারিখ </td>
                                                <td valign="top"> : </td>
                                                <td><?php echo $sql->attend_ceo; ?></td>
                                    ...
                                    <p style="text-align:center; margin-top:20px; margin-right:100px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td valign="top">
                                                        <a href="#" onclick="window.open('<?php echo base_url(); ?>uploads/Register/<?php echo $sql->register_id; ?>/<?php echo $v; ?>')">ফাইল দেখুন </a>

                                                    </td>
                                                    <td valign="top">
                                                        <a href="<?php echo base_url(); ?>uploads/Register/<?php echo $sql->register_id; ?>/<?php echo $v; ?>" download> ফাইল ডাউনলোড </a>
