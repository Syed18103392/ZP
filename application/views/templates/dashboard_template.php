						...
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-4">
                                  <a href="<?php echo base_url()?>Page/view_management">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-8">
                                    <a href="<?php echo base_url()?>Recoad/land_recoad_info"> 
                                     <div class="panel-body list-box">
                            ...
                            <?php if($userid == 'super' || $userid == 'marketT'|| $userid == 'engineer'){ ?> 
                             <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-11">
                                  <a href="<?php echo base_url()?>Recoad/tranning_info">  
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-4">
                                   <a href="<?php echo base_url()?>Register/all_register">  
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-1">
                                      <a href="<?php echo base_url()?>Recoad/case_info"> 
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                           ...
                           <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-3">
                                    <a href="<?php echo base_url()?>Recoad/project"> 
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-12">
                                    <a href="<?php echo base_url()?>Recoad/audit_info">  
                                    <div class="panel-body list-box">
                                      <div class="cardbox-icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                             ...
                             <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-3">
                                   <a href="<?php echo base_url()?>Recoad/fdr_info">  
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-1">
                                   <a href="<?php echo base_url()?>Recoad/land_recoad"> 
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
                          ...
                          <!--   <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="panel cardbox bg-4">
                                  <a href="<?php echo base_url()?>Recoad/land_lease"> 
                                    <div class="panel-body list-box">
                                        <div class="cardbox-icon">
